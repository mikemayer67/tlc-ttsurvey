# TLC Time and Talent Survey App

The manual for this app consists of a number of information pages.
In no particular order, here are the topics addressed in this manual.

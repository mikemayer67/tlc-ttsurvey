...
/**
 * The survey participant information is stored in the tlc_tts_userids table
...
function create_new_user($userid,$fullname,$password,$email=null)
{
  ...
  if($email) {
    $r = MySQLExecute(
      "insert into tlc_tts_userids (userid,fullname,email,password) values (?,?,?,?)",
      "ssss",
      $userid,$fullname,$email,$password
    );
  } else {
    $r = MySQLExecute(
      "insert into tlc_tts_userids (userid,fullname,password) values (?,?,?)",
      "sss",

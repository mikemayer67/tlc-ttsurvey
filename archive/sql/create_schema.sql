--------------------------------------------------------------------------------
-- The script is now OBE.  It has been replaced with the easier to maintain
--   create, update, and migrate scripts.  The replacement no longer uses 
--   stored procedures or version tracking to manage the logic within the script.
-- This script is retained in the archive folder as it was sophisticated 
--   approach to managing creating and updating of the database structure.
--   Unfortunately it became increasingly difficult to keep it working correctly
--   and has been abandonded (but not forgotten)
--------------------------------------------------------------------------------
